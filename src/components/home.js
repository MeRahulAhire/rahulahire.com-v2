...
import vid1 from "../assets/sec1-halftone.mp4";
import vid2 from "../assets/pune-3d-view.mp4";
import vid3 from "../assets/pune-to-shirur.mp4";
import vid4 from "../assets/my-facination.mp4";
import vid5 from "../assets/elon-musk.mp4";
  ...
  return (
    <>
      ...
      <section className="sec-container">
        <div className="sidedrawer sd-sec1">
        ...
        <div className="vid-container">
          <video
            ...
            // autoPlay
          ></video>
          <div className="vid1-dimmer" />
        </div>
        <div className="mob-drawer sd-sec1">
      ...
      <section className="sec-container">
        ...
        <div className="vid-container">
          <video src={vid2} muted id="vid2" className="video"></video>
        </div>
      ...
      <section className="sec-container">
        ...
        <div className="vid-container">
          <video src={vid3} muted id="vid3" className="video"></video>
        </div>
      ...
      <section className="sec-container">
        ...
        <div className="vid-container">
          <video src={vid4} muted id="vid4" className="video"></video>
        </div>
      ...
      <section className="sec-container">
        ...
        <div className="vid-container">
          <video src={vid5} muted id="vid5" className="video"></video>
        </div>
